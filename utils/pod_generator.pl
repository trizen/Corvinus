...
my $dir = shift() // die "usage: $0 Corvinus/lib\n";
...
my %ignored_methods = (
                       'Corvinus'                          => [qw(new)],
                       'Corvinus::Types::Block::Return'    => [qw(get_obj new)],
                       'Corvinus::Types::Block::Break'     => [qw(new)],
                       'Corvinus::Variable::Variable'      => [qw(set_value is_defined get_type get_value new)],
                       'Corvinus::Variable::Ref'           => [qw(get_var new)],
