package Corvinus::Types::Array::MultiArray {
    ...
    *noua = \&new;
    ...
    sub get_value {
        ...
        [
         map {
             [map { index(ref($_), 'Corvinus::') == 0 ? $_->get_value : $_ } @{$_}]
           } @{$self}
        ];
    }
    ...
    sub map {
        ...
        Corvinus::Types::Array::Array->new(@arr);
    }
    ...
    *push = \&append;
    ...
    sub to_array {
        my ($self) = @_;
        Corvinus::Types::Array::Array->new(map { Corvinus::Types::Array::Array->new(@{$_}) } @{$self});
    }
