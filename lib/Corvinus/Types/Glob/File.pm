package Corvinus::Types::Glob::File {
    ...
    *nou = \&new;
    ...
    sub get_constant($self, $str) {
        ...
        warn qq{[AVIZ] Constantă inexistentă „$name” pentru obiectul de tip „Fisier”!\n};
        return;
    }
    ...
    sub open {
        ...
        if (defined $fh_ref) {
            ...
            return $success
              ...
              : do {
                defined($err_ref) && $err_ref->get_var->set_value(Corvinus::Types::String::String->new($error));
    ...
    *deschide_citire_scriere = \&open_rw;
    ...
    *deschide_dosar = \&opendir;
    ...
    sub sysopen {
        ...
        if ($success) {
            $var_ref->get_var->set_value(Corvinus::Types::Glob::FileHandle->new(fh => $fh, self => $self));
        }
    ...
    *sterge = \&unlink;
    ...
    sub dump {
        my ($self) = @_;
        Corvinus::Types::String::String->new('File.new(' . ${Corvinus::Types::String::String->new($self->get_value)->dump} . ')');
    }
